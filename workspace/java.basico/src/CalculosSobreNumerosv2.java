...
public class CalculosSobreNumerosv2 {
	public static void main(String[] args) {
		...
		Scanner leLinhas = new Scanner(System.in);
		
		final int N = recebeInteiro(leNumeros, "quantos numeros vai considerar?");
		int[] numeros = new int[N];
		recebeNumeros(leNumeros, numeros);
		...
		while (true) {
			...
			case "4":
				boolean encontrou = pesquisa(leNumeros, numeros);
